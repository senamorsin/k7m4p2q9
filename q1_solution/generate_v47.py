#!/usr/bin/env python3
"""v47: Continue ITER chain. Base = ITER_q07_q03_r07 = 7.15659.

Pattern: ITER (apply proxy twice) gives -0.02 per iteration. Keep going.
"""
...
N_INST = 90.09
BASE_FILE = "submission_FBSv46_ITER_q07_q03_r07.csv"
BASE_SCORE = 7.156591930447194
...
KNOWN_SCORES = {
    ...
    "submission_FBSv46_NP_r07_t08_p35_n55.csv": 7.176476083161900,
    "submission_FBSv46_NP_r07_t10_p35_n55.csv": 7.174484396667588,
    "submission_FBSv46_NP_r07_t07_p35_n55.csv": 7.172212196435162,
    "submission_FBSv46_NP_r07_t07_p30_n55.csv": 7.173287785323630,
    "submission_FBSv46_NP_TOP6_t07_w010.csv": 7.171978091259379,
    "submission_FBSv46_NP_v61_t07_w010.csv": 7.172267135200906,
    "submission_FBSv46_NP_FRR_t07_w10.csv": 7.172635112109134,
    "submission_FBSv46_STACK_TOP3.csv": 7.171945383636624,
    "submission_FBSv46_NP_r05_t07_p35_n55.csv": 7.193460272240554,
    "submission_FBSv46_ENS_t07.csv": 7.182908525393075,
}
...
def save(label, values, target_col):
    ...
    path = ROOT / f"submission_FBSv47_{label}.csv"
...
def main():
    ...
    # ====== S1: NP grid on new base (try many rms + q combos) ======
    ...
    # ====== S2: ITER again (apply proxy twice) ======
    ...
    pool_path = ROOT / POOL
    top6, _ = load("submission_TOP6_MEDIAN.csv")
    if top6 is None:
    ...
    # ====== S4: Stack v46 winners ======
    winners = [
        BASE_FILE,
        "submission_FBSv46_ITER_q05_q05_r07.csv",
        "submission_FBSv46_ITER_q07_q05_r07.csv",
        "submission_FBSv46_ITER_q07_q07_r07.csv",
        "submission_FBSv46_ITER_q05_q03_r07.csv",
        "submission_FBSv46_ITER_q10_q05_r07.csv",
        "submission_FBSv46_NP_r07_t06_p35_n55.csv",
        "submission_FBSv46_NP_r07_t07_p40_n50.csv",
    ]
    arrs = []
    for fn in winners:
        v, _ = load(fn)
    ...
    (ROOT / "v47_report.json").write_text(
        json.dumps(report, indent=2, ensure_ascii=False), encoding="utf-8")
    print(f"\nWrote {len(outputs)} v47 candidates")
